...
// Приватность: наружу только обезличенные категории ("lte"/"3g"/флаги) и стандартный ЧИСЛОВОЙ
// код оператора MCC-MNC (напр. "250-02" — категория, не имя сети/BSSID; последнее на сервер НИКОГДА).
...
// Обезличенный код оператора "MCC-MNC" (напр. "250-02"), "" если недоступно (iOS 16+ / не сотовая).
QString carrierCode();
