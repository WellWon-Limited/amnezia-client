...
constexpr static const auto DRIVER_SERVICE_NAME = L"TribeVPNSplitTunnel"; // AVPN: своя запись в SCM, не делить с офиц. Amnezia
...
SC_HANDLE WindowsSplitTunnel::installDriver() {
  LPCWSTR displayName = L"Tribe Split Tunnel Service";
