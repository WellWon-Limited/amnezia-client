...
#   • схема 5.0.x: 5.0.0 → 5.0.1 → … → 5.0.9 → 5.1.0; НИКОГДА не 4.9.x и НИКОГДА не 2.4.x
#     (2.4.x < 4.9.x = откат → Apple отклоняет, апдейты не доходят — уже ломалось на 2.4.1);
#   • iOS/macOS build-number (BUILD) > последнего залитого в TestFlight (последний = 30);
...
set(TRIBE_VERSION 5.1.6.31)
set(TRIBE_ANDROID_VERSION_CODE 2134)
